<?php ob_start();?>
 ...
 <div class="container">
     <div class="row">
         ...
         <h1 class="display-6 text-center font-monospace text-decoration-underline">Editer la voiture N°0<?=$editCar->getId_v();?></h1>
             <form action="<?php $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <textarea id="desc" name="desc" class="form-control" placeholder="La description" rows="5"><?=$editCar->getDescription();?></textarea>
                    </div>
                </div>
